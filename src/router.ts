// @routes-hash 397abd99a42e11c26916b12e72d23e6d
...
import route35 from "./routes/login/sso";
...
import route101 from "./routes/script/addScript";
import route102 from "./routes/script/batchAddScript";
import route103 from "./routes/script/delScript";
import route104 from "./routes/script/exportScript";
import route105 from "./routes/script/extractAssets";
import route106 from "./routes/script/getAiRegex";
import route107 from "./routes/script/getScrptApi";
import route108 from "./routes/script/pollScriptAssets";
import route109 from "./routes/script/updateScript";
import route110 from "./routes/scriptAgent/getPlanData";
import route111 from "./routes/scriptAgent/setPlanData";
import route112 from "./routes/scriptAgent/updateData";
import route113 from "./routes/setting/about/checkUpdate";
import route114 from "./routes/setting/about/downloadApp";
import route115 from "./routes/setting/agentDeploy/agentSetKey";
import route116 from "./routes/setting/agentDeploy/deployAgentModel";
import route117 from "./routes/setting/agentDeploy/getAgentDeploy";
import route118 from "./routes/setting/dbConfig/clearData";
import route119 from "./routes/setting/dbConfig/clearTable";
import route120 from "./routes/setting/dbConfig/dbInfo";
import route121 from "./routes/setting/dbConfig/exportData";
import route122 from "./routes/setting/dbConfig/importData";
import route123 from "./routes/setting/dev/getSwitchAiDevTool";
import route124 from "./routes/setting/dev/updateSwitchAiDevTool";
import route125 from "./routes/setting/fileManagement/openFolder";
import route126 from "./routes/setting/getTextModel";
import route127 from "./routes/setting/loginConfig/getUser";
import route128 from "./routes/setting/loginConfig/updateUserPwd";
import route129 from "./routes/setting/memoryConfig/delAllMemory";
import route130 from "./routes/setting/memoryConfig/getMemory";
import route131 from "./routes/setting/memoryConfig/sureMemory";
import route132 from "./routes/setting/modelMap/bindingPrompt";
import route133 from "./routes/setting/modelMap/getImageAndVideoModel";
import route134 from "./routes/setting/promptManage/getPrompt";
import route135 from "./routes/setting/promptManage/updatePrompt";
import route136 from "./routes/setting/skillManagement/getSkillContent";
import route137 from "./routes/setting/skillManagement/getSkillList";
import route138 from "./routes/setting/skillManagement/saveSkillContent";
import route139 from "./routes/setting/vendorConfig/addVendor";
import route140 from "./routes/setting/vendorConfig/addVendorModel";
import route141 from "./routes/setting/vendorConfig/deleteVendor";
import route142 from "./routes/setting/vendorConfig/delVendorModel";
import route143 from "./routes/setting/vendorConfig/enableVendor";
import route144 from "./routes/setting/vendorConfig/getCodeByLink";
import route145 from "./routes/setting/vendorConfig/getVendorList";
import route146 from "./routes/setting/vendorConfig/modelTest";
import route147 from "./routes/setting/vendorConfig/updateCode";
import route148 from "./routes/setting/vendorConfig/updateVendorInputs";
import route149 from "./routes/setting/vendorConfig/upVendorModel";
import route150 from "./routes/task/getProject";
import route151 from "./routes/task/getTaskApi";
import route152 from "./routes/task/getTaskCategories";
import route153 from "./routes/task/taskDetails";
import route154 from "./routes/test/test";
...
export default async (app: Express) => {
  ...
  app.use("/api/script/addScript", route101);
  app.use("/api/script/batchAddScript", route102);
  app.use("/api/script/delScript", route103);
  app.use("/api/script/exportScript", route104);
  app.use("/api/script/extractAssets", route105);
  app.use("/api/script/getAiRegex", route106);
  app.use("/api/script/getScrptApi", route107);
  app.use("/api/script/pollScriptAssets", route108);
  app.use("/api/script/updateScript", route109);
  app.use("/api/scriptAgent/getPlanData", route110);
  app.use("/api/scriptAgent/setPlanData", route111);
  app.use("/api/scriptAgent/updateData", route112);
  app.use("/api/setting/about/checkUpdate", route113);
  app.use("/api/setting/about/downloadApp", route114);
  app.use("/api/setting/agentDeploy/agentSetKey", route115);
  app.use("/api/setting/agentDeploy/deployAgentModel", route116);
  app.use("/api/setting/agentDeploy/getAgentDeploy", route117);
  app.use("/api/setting/dbConfig/clearData", route118);
  app.use("/api/setting/dbConfig/clearTable", route119);
  app.use("/api/setting/dbConfig/dbInfo", route120);
  app.use("/api/setting/dbConfig/exportData", route121);
  app.use("/api/setting/dbConfig/importData", route122);
  app.use("/api/setting/dev/getSwitchAiDevTool", route123);
  app.use("/api/setting/dev/updateSwitchAiDevTool", route124);
  app.use("/api/setting/fileManagement/openFolder", route125);
  app.use("/api/setting/getTextModel", route126);
  app.use("/api/setting/loginConfig/getUser", route127);
  app.use("/api/setting/loginConfig/updateUserPwd", route128);
  app.use("/api/setting/memoryConfig/delAllMemory", route129);
  app.use("/api/setting/memoryConfig/getMemory", route130);
  app.use("/api/setting/memoryConfig/sureMemory", route131);
  app.use("/api/setting/modelMap/bindingPrompt", route132);
  app.use("/api/setting/modelMap/getImageAndVideoModel", route133);
  app.use("/api/setting/promptManage/getPrompt", route134);
  app.use("/api/setting/promptManage/updatePrompt", route135);
  app.use("/api/setting/skillManagement/getSkillContent", route136);
  app.use("/api/setting/skillManagement/getSkillList", route137);
  app.use("/api/setting/skillManagement/saveSkillContent", route138);
  app.use("/api/setting/vendorConfig/addVendor", route139);
  app.use("/api/setting/vendorConfig/addVendorModel", route140);
  app.use("/api/setting/vendorConfig/deleteVendor", route141);
  app.use("/api/setting/vendorConfig/delVendorModel", route142);
  app.use("/api/setting/vendorConfig/enableVendor", route143);
  app.use("/api/setting/vendorConfig/getCodeByLink", route144);
  app.use("/api/setting/vendorConfig/getVendorList", route145);
  app.use("/api/setting/vendorConfig/modelTest", route146);
  app.use("/api/setting/vendorConfig/updateCode", route147);
  app.use("/api/setting/vendorConfig/updateVendorInputs", route148);
  app.use("/api/setting/vendorConfig/upVendorModel", route149);
  app.use("/api/task/getProject", route150);
  app.use("/api/task/getTaskApi", route151);
  app.use("/api/task/getTaskCategories", route152);
  app.use("/api/task/taskDetails", route153);
  app.use("/api/test/test", route154);
}
